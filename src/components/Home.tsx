...
export const Home = () => {
  ...
  return (
    <>
      <div>
        <div className="flex items-center justify-center w-full h-96 bg-cover bg-center bg-[url('../public/header.jpg')]">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-4 gap-2 padding-55">
